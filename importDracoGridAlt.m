 ...
 function rayGd = importDracoGridAlt(dracoFile,iTime,addVarFlag,critDens)
%
...
%
 ...
 newPtsInd = find(rayGd.valsNe < log(critDens)/log(10));
 newPts = Pts(newPtsInd,:);

 rayGd.DT = delaunayTriangulation(newPts); 
